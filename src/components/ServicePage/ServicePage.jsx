      ...
      <div className='flex md:gap-6 gap-4 flex-wrap items-center justify-center'>
        {service.map((items) => {
          ...
          return (
            <div
              key={id}
              className='servicesCards max-h-max md:w-[350px] sm:w-[300px] w-full transition-all flex flex-col items-start justify-start py-4 px-10 shadow-md border rounded-md'
            >
              <i
